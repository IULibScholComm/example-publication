...
\makeatother
\subtitle{An Example of an IUB Libraries Scholarly Communication
Deparment Published Book}
\author{Adam Mazel}
\date{2023-04-12}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, toprule=.15mm, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, rightrule=.15mm, breakable, toptitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6]
