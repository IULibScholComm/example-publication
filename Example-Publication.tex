...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, toprule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, opacitybacktitle=0.6, rightrule=.15mm, breakable, bottomrule=.15mm, arc=.35mm, colback=white]
