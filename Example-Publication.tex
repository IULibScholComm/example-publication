...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, breakable, left=2mm, rightrule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacityback=0, toptitle=1mm, titlerule=0mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
