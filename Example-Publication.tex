...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, bottomtitle=1mm, left=2mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, toptitle=1mm, titlerule=0mm, rightrule=.15mm]
