...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, arc=.35mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, leftrule=.75mm, left=2mm, rightrule=.15mm, opacityback=0, coltitle=black, breakable]
