...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, coltitle=black, leftrule=.75mm, opacityback=0, breakable, toprule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, arc=.35mm, toptitle=1mm, titlerule=0mm, rightrule=.15mm, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
