...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toptitle=1mm, arc=.35mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, titlerule=0mm]
...
\leavevmode\vadjust pre{\hypertarget{about-author}{}}%
