...
\makeatother
\subtitle{of the IUB Libraries Scholarly Communication Department
Publishing Service}
\author{Adam Mazel}
\date{2023-April-21}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, arc=.35mm, titlerule=0mm, opacitybacktitle=0.6, bottomrule=.15mm, colback=white, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, left=2mm, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, breakable, colframe=quarto-callout-note-color-frame]
