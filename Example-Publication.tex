...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, coltitle=black, titlerule=0mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomtitle=1mm, arc=.35mm, left=2mm, opacityback=0, colback=white]
