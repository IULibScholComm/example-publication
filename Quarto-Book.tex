...
\makeatother
\subtitle{An Example of Schol Comm Publications}
\author{Adam Mazel}
\date{2023-04-12}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, boxrule=0pt, frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, breakable, opacityback=0, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, leftrule=.75mm, coltitle=black, bottomtitle=1mm, opacitybacktitle=0.6, arc=.35mm, left=2mm, toprule=.15mm, rightrule=.15mm, colback=white]
