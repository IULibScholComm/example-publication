...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, breakable, left=2mm, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Box 1: Lorem Ipsum}, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, leftrule=.75mm, opacityback=0]
